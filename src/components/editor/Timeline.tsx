    ...
    <div className="h-24 border-t border-white/[0.08] bg-[#090D16]/85 backdrop-blur-xl px-6 flex flex-col justify-center gap-2 select-none z-20">
      ...
      <div className="relative flex items-center group">
        ...
        >
          {/* Played Progress bar */}
          <div
            className="h-full bg-gradient-to-r from-sky-500 to-sky-400 rounded-full relative shadow-[0_0_12px_rgba(56,189,248,0.4)]"
            style={{ width: `${progressPercent}%` }}
          >
            {/* Playhead thumb */}
            <div className="absolute right-0 top-1/2 -translate-y-1/2 w-4 h-4 rounded-full bg-white shadow-glass-md border-2 border-sky-400 scale-90 group-hover:scale-110 transition-transform" />
          </div>
            ...
            return (
              <button
                ...
                className={`absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-3.5 h-3.5 rounded-full z-10 transition-transform hover:scale-150 flex items-center justify-center border border-white/60 ${
                  ev.enabled ? "bg-sky-400 shadow-[0_0_8px_rgba(56,189,248,0.6)]" : "bg-slate-600 opacity-60"
                }`}
