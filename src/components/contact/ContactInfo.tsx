  ...
  return (
    <div className="space-y-6 select-none">
      ...
      <div className="space-y-3.5 pt-2">
        ...
        <div className="p-4 sm:p-5 rounded-2xl sm:rounded-3xl bg-[#080D1A]/70 border border-white/10 hover:border-sky-400/40 backdrop-blur-xl transition-all duration-300 flex items-center justify-between group">
          <div className="flex items-center gap-3.5">
            <div className="w-10 h-10 rounded-xl bg-white/[0.04] border border-white/10 flex items-center justify-center text-sky-400 group-hover:bg-sky-500/20 group-hover:border-sky-400/40 transition-all">
        ...
        <div className="p-4 sm:p-5 rounded-2xl sm:rounded-3xl bg-[#080D1A]/70 border border-white/10 backdrop-blur-xl flex items-center gap-3.5">
          <div className="w-10 h-10 rounded-xl bg-white/[0.04] border border-white/10 flex items-center justify-center text-sky-400">
        ...
        {/* Privacy Note */}
        <div className="p-4 sm:p-5 rounded-2xl sm:rounded-3xl bg-sky-950/20 border border-sky-500/20 backdrop-blur-xl flex items-start gap-3.5">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-300/80 leading-relaxed">
              When using FocuFlow Studio, your recorded video frames are rendered 100% on your local device. No video assets are uploaded to any server.
            </p>
          </div>
        </div>
      </div>
