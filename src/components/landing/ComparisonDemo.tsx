...
export function ComparisonDemo() {
  ...
  return (
    <section className="py-24 relative overflow-hidden bg-[#060913] text-white border-t border-white/[0.08] select-none">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[500px] bg-sky-500/[0.05] rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden bg-[#080D1A]/90 border border-white/15 aspect-[16/9] shadow-[0_20px_60px_rgba(0,0,0,0.8),0_0_40px_rgba(56,189,248,0.1)] backdrop-blur-2xl select-none">
            ...
            <div className="absolute inset-0 bg-[#080D1A] p-6 sm:p-10 flex items-center justify-center">
              <div className="w-full h-full rounded-2xl bg-white/[0.03] border border-white/10 backdrop-blur-md p-6 relative overflow-hidden flex flex-col justify-center items-center text-center">
                ...
                <div className="scale-125 transition-transform duration-300 space-y-2.5">
                  <div className="px-4 py-2 rounded-full bg-sky-500/20 text-sky-200 font-medium text-xs border border-sky-400/30 shadow-[0_0_20px_rgba(56,189,248,0.2)] backdrop-blur-md inline-flex items-center gap-2">
            ...
            <div
              className="absolute inset-y-0 left-0 overflow-hidden bg-[#060914] border-r border-sky-400/80 shadow-[0_0_20px_rgba(56,189,248,0.5)]"
            ...
            <div className="absolute top-4 right-4 z-10 pointer-events-none">
              <span className="px-3 py-1.5 rounded-full text-[11px] font-mono font-medium bg-sky-500/20 text-sky-200 border border-sky-400/30 backdrop-blur-md shadow-[0_0_15px_rgba(56,189,248,0.3)]">
                After: FocuFlow Studio
              </span>
            </div>
          </div>
        </div>
