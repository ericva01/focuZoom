        ...
        <div className="rounded-3xl bg-[#17191F] p-8 sm:p-12 lg:p-16 text-white text-center relative overflow-hidden shadow-xl border border-white/10">
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-6">
            ...
            <h2 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight">
              Ready to transform how your team communicates through video?
            </h2>
            ...
            <div className="pt-6 flex flex-wrap items-center justify-center gap-6 text-xs text-slate-400">
              <span className="flex items-center gap-1.5">
                <CheckCircle2 size={14} className="text-[#FF6B2C]" /> 100% Free & Open Source
              </span>
              <span className="flex items-center gap-1.5">
                <CheckCircle2 size={14} className="text-[#FF6B2C]" /> Instant browser launch
              </span>
              <span className="flex items-center gap-1.5">
                <CheckCircle2 size={14} className="text-[#FF6B2C]" /> Stored 100% on your device
              </span>
            </div>
          </div>
        </div>
